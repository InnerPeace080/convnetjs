...
(function(global) {
  ...
  var Brain = function(num_states, num_actions, opt) {
    ...
    this.epsilon_start = typeof opt.epsilon_start !== 'undefined' ? opt.epsilon_start : 1;
    ...
    if (opt.networkJSON) {
      ...
      this.value_net.fromJSON(opt.networkJSON)
    }else{
  ...
  Brain.prototype = {
    ...
    forward: function(input_array) {
      ...
      if(this.forward_passes > this.temporal_window) {
        ...
        if(this.learning) {
          ...
          this.epsilon = Math.min(1.0, Math.max(this.epsilon_min,(this.epsilon_start?this.epsilon_start: 1.0)-(this.age - this.learning_steps_burnin)/(this.learning_steps_total - this.learning_steps_burnin)));
        } else {
    ...
    fromJSON(JSON){
      ...
      this.tdtrainer = new convnetjs.SGDTrainer(this.value_net, this.tdtrainer_options);
    }
  }
